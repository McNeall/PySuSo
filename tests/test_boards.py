...
def fixture_example_board_representation() -> str:
    ...
    """
    # Disable formatting to keep the alignment
    # fmt: off
    return (
        f"┌───┬───┬───┬───┬───┬───┬───┬───┬───┐{os.linesep}"
        f"│ 0 │ 5 │ 0 │ 7 │ 0 │ 3 │ 0 │ 6 │ 0 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 0 │ 0 │ 7 │ 0 │ 0 │ 0 │ 8 │ 0 │ 0 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 0 │ 0 │ 0 │ 8 │ 1 │ 6 │ 0 │ 0 │ 0 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 0 │ 0 │ 0 │ 0 │ 3 │ 0 │ 0 │ 0 │ 0 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 0 │ 0 │ 5 │ 0 │ 0 │ 0 │ 1 │ 0 │ 0 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 7 │ 3 │ 0 │ 0 │ 4 │ 0 │ 0 │ 8 │ 6 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 9 │ 0 │ 6 │ 0 │ 0 │ 0 │ 2 │ 0 │ 4 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 8 │ 4 │ 0 │ 5 │ 7 │ 2 │ 0 │ 9 │ 3 │{os.linesep}"
        f"├───┼───┼───┼───┼───┼───┼───┼───┼───┤{os.linesep}"
        f"│ 0 │ 0 │ 0 │ 4 │ 0 │ 9 │ 0 │ 0 │ 0 │{os.linesep}"
         "└───┴───┴───┴───┴───┴───┴───┴───┴───┘"
    )
    # fmt: on
